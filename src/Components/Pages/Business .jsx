    ...
    <div className='mt-4 pt-5'>
      <div className='bg-red-50 pt-10'>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center mx-auto py-10 px-4 max-w-screen-lg">
          ...
          <div className="w-full md:w-1/2 md:pl-10 text-center md:text-left">
            ...
            <button className="bg-[#f73a50] text-white py-2 px-6 rounded-md mb-4 hover:bg-pink-600 transition duration-200">
              Enquire Now
            </button>
      ...
      <div className="flex flex-col md:flex-row items-center justify-around mx-auto py-8 px-4 max-w-screen-lg">
        ...
        <div className="text-center mb-8 md:mb-0">
          <div className="flex items-center justify-center border-2 border-[#f73a50] rounded-full w-32 h-32 mx-auto">
            <span className="text-[#f73a50] text-xl font-semibold">
              ₹130 cr+
            </span>
          </div>
